...
//// test for minimized deltap, using 5 different alpha for all particles
...
// // double CDProt[3][4] = {
// //     {-0.05237, 0.3066, -0.5225, 0.1763}, {0.0853, -0.275, 0.2484, -0.0692}, {0.0435, -0.1208, 0.128, -0.0371}}; //3
// //     rd order pol
