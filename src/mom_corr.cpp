...
// //// Our delta p corrections : NEW method FOR ALL W RANGE USING TWOPION skim data  (for august version of task force
// corrections) double CDProt[3][5] = {{-0.1449, 0.769, -1.321, 0.791, -0.1771},
//                        {0.0229, 0.02892, -0.27, 0.309, -0.09827},
//                        {0.005405, 0.07715, -0.2913, 0.3364, -0.11163}};

// ( for december version of task force corrections)
double CDProt[3][5] = {{-0.1417, 0.753, -1.3, 0.791, -0.1948},
                       {-0.00873, 0.1567, -0.4438, 0.3997, -0.1268},
                       {0.0031, 0.0886, -0.311, 0.3523, -0.1309}};
...
// ( for december version of task force corrections)
float FDProt[6][3] = {{-0.000604, 0.002537, -0.01492},  {0.0006604, 0.004826, -0.01689},
                      {-0.002535, 0.007584, -0.01166},  {-0.000804, -0.002163, -0.003496},
                      {0.000765, -0.002775, -0.006405}, {-0.002056, 0.0001497, -0.009705}};
...
// ( for december version of task force corrections)
double CDPip[3][5] = {{-0.000514, 0.0496, -0.08167, -0.06192, 0.005222},
                      {-0.003096, 0.0444, -0.08795, 0.03757, -0.00576},
                      {-0.07715, 0.2489, -0.2273, 0.0795, -0.0161}};
...
// ( for august version of task force corrections)

// float FDPip[6][3] = {{-0.001234, 0.00964, -0.02257},  {-0.0011, 0.00877, -0.01706},     {-0.001352, 0.00768,
// -0.00938},
//                      {-0.00066, 0.002325, -0.005512}, {0.0003505, -0.005337, 0.003468}, {-0.0006557, 0.0032,
//                      -0.01096}};

// ( for december version of task force corrections)
float FDPip[6][3] = {{-0.001261, 0.01077, -0.03087}, {-0.0010195, 0.00921, -0.02463}, {-0.001834, 0.01351, -0.0274},
                     {-0.001151, 0.00908, -0.02686}, {-0.000538, 0.00587, -0.02687},  {-0.001016, 0.01044, -0.0362}};
...
double CDPim[3][5] = {{-0.0889, 0.3623, -0.4504, 0.2126, -0.03442},
                      {-0.02318, 0.08997, -0.0894, 0.05728, -0.004807},
                      {-0.1123, 0.4458, -0.559, 0.2086, -0.024}};
...
// ( for december version of task force corrections)
float FDPim[6][3] = {{-0.001804, 0.002823, -0.01846}, {-0.0003567, -0.00049, -0.01116},
                     {-0.00183, 0.007786, -0.02238},  {0.001377, -0.006855, -0.00961},
                     {-0.004303, 0.013016, -0.02481}, {-0.001729, 0.005753, -0.02551}};
