...
// proton mom corr
float alpha_prot_mom_corr_FD[5] = {0.7,0.5, 0.6, 0.05}; // all fd low, except all fd low, all fd high, except all fd high
float alpha_prot_mom_corr_CD[3] = {0.9, 0.5, 0.95};
