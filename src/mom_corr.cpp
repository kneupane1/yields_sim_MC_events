...
//   float alpha_prot_mom_corr_FD[4] = {0.5, 0.6, 0.5,0.5};  // all fd low, except all fd low, all fd high, except all
//   fd high std::srand(std::time(nullptr));  // seed the random number generator for (int i = 0; i < 4; i++) {
