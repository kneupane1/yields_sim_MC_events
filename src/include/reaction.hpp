...
class Reaction {
 protected:
  ...
  float alpha_prot_mom_corr[3] = {0.7, 0.0, 0.0};
...
//   float alpha_prot_mom_corr_2nd[3] = {0.0, 0.0, 0.0};  // CD , FD < 27 (DEG), FD > 27 (DEG)
  ...
  float prot_mom_corr_CD[Prot_mom_bins_CD] = {
      0.003, -0.0144, -0.024, -0.0336, -0.0528, -0.0528, -0.077, -0.091, -0.104, -0.12, -0.15,
  };
  ...
  double prot_mom_corr_FD[2][Prot_mom_bins_FD] = {
      {0.003, 0.0048, -0.0048, -0.0144, -0.0144, -0.0144, -0.021, -0.021, -0.035, -0.024, -0.04, -0.024, -0.05, -0.05,
       -0.05, -0.05, -0.03},
      {0.009, 0.0048, 0.0048, 0.0048, 0.0048, -0.0048, -0.007, -0.007, -0.007, -0.008, -0.008, -0.008, -0.01, -0.01, 0.01, 0.01, 0.01}};  // first is for theta < 27 and second is for theta > 27 degrees,
  ...
  float alpha_pip_mom_corr[3] = {0.2, 0.0, 0.0};
...
//   float alpha_pip_mom_corr_2nd[3] = {0.00, 0.0, 0.4};  // CD , FD < 27 (DEG), FD > 27 (DEG)
  ...
  float pip_mom_corr_CD[Pip_mom_bins_CD] = {
      0.045,  0.009,   -0.003,  -0.009,  -0.015, -0.015,  -0.021, -0.027, -0.033,
      -0.039, -0.0432, -0.0528, -0.0624, -0.072, -0.0816, -0.105, -0.15,
  };

  float min_pip_mom_values_FD[Pip_mom_bins_FD] = {0,    0.65, 0.75, 0.85, 0.95, 1.05, 1.15, 1.25, 1.35,
                                                  1.45, 1.55, 1.65, 1.75, 1.9,  2.1,  2.5,  3.0};
  float max_pip_mom_values_FD[Pip_mom_bins_FD] = {0.65, 0.75, 0.85, 0.95, 1.05, 1.15, 1.25, 1.35, 1.45,
                                                  1.55, 1.65, 1.75, 1.9,  2.1,  2.5,  3.0,  5.0};
  double pip_mom_corr_FD[2][Pip_mom_bins_FD] = {{-0.003, -0.0048, -0.0144, -0.024, -0.024, -0.024, -0.021, -0.035,
                                                 -0.021, -0.024, -0.008, -0.024, -0.03, -0.03, -0.03, -0.01, -0.01},
                                                {0.026, 0.015, 0.021, 0.027, 0.027, 0.027, 0.02, 0.028, 0.028, 0.028,
                                                0.028, 0.028, 0.036, 0.036, 0.044, 0.052, 0.076,}};  // first is for theta < 27 and second is for theta > 27 degrees,
                                                      // last one for >27 is adjusted to second last one
  // float pip_mom_corr_CD_2nd[Pip_mom_bins_CD] = {0.033, 0.003,   0.009,   0.009,   0.009,   0.009,   0.021, 0.009, 0.003,
  //                                               0.009, -0.0048, -0.0048, -0.0048, -0.0048, -0.0336, 0.007, -0.09};

  // double pip_mom_corr_FD_2nd[2][Pip_mom_bins_FD] = {
  //     {},
  //     { }};  // here we can see the correction did bad job on theta > 27 degree
  ...
  float alpha_pim_mom_corr[3] = {0.2, 0.0, 0.0};
  ...
  float pim_mom_corr_CD[Pim_mom_bins_CD] = {0.039,   0.009,   -0.003,  -0.003,  -0.0048, -0.0048,
                                            -0.0144, -0.0144, -0.0144, -0.0144, -0.024,  -0.024,
                                            -0.024,  -0.024,  -0.0336, -0.035,  -0.05};

  float min_pim_mom_values_FD[Pim_mom_bins_FD] = {0,    0.65, 0.75, 0.85, 0.95, 1.05, 1.15, 1.25, 1.35,
                                                  1.45, 1.55, 1.65, 1.75, 1.9,  2.1,  2.5,  3.0};
  float max_pim_mom_values_FD[Pim_mom_bins_FD] = {0.65, 0.75, 0.85, 0.95, 1.05, 1.15, 1.25, 1.35, 1.45,
                                                  1.55, 1.65, 1.75, 1.9,  2.1,  2.5,  3.0,  5.0};
  double pim_mom_corr_FD[2][Pim_mom_bins_FD] = {
      {0.057, -0.0144, -0.0336, -0.0336, -0.024, -0.024, -0.021, -0.035, -0.035, -0.04, -0.024, -0.024, -0.03, -0.03,
       -0.03, -0.01, -0.01},
      {0.027, -0.0048, -0.0144, -0.0144, -0.0144, -0.0144, -0.021, -0.007, -0.021, -0.008, -0.008, -0.008, -0.03, -0.01,
       -0.01, -0.01, -0.01}};  // first is for theta < 27 and second is for theta > 27 degrees, last bin for > 27 is
