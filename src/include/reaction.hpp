...
//   float alpha_pip_mom_corr_2nd[3] = {0.00, 0.0, 0.4};  // CD , FD < 27 (DEG), FD > 27 (DEG)
  ...
  float pip_mom_corr_CD[Pip_mom_bins_CD] = {0.045,  0.015,   0.003,   -0.003,  -0.003,  -0.009, -0.009, -0.015, -0.021,
  ...
  double pip_mom_corr_FD[2][Pip_mom_bins_FD] = {
      {0.021, 0.024, 0.0144, -0.0048, -0.0048, 0.0048, -0.007, -0.007, 0.007, 0.008, 0.008, 0.008, 0.01, -0.01, -0.01,
       0.01, 0.01},
      {0.025, 0.021, 0.027, 0.027, 0.027, 0.027, 0.028, 0.028, 0.028, 0.028, 0.028, 0.028, 0.028, 0.028, 0.036, 0.028,
