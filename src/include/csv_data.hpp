...
struct csv_data {
  ...
  static std::string header() {
    ...
    return "pim_mom_mPim,pim_theta_mPim,pim_phi_mPim,mm2_mPim,mm2_mPim_corr,weight,pip_mom_mes,pip_theta_mes,pip_phi_"
           "mes,prot_mom_mes,prot_theta_mes,prot_phi_mes";
